...
\usepackage{listings}
% margins
\usepackage[a4paper,includeheadfoot,margin=1.5in,top=5mm,head=47.5pt]{geometry}
% headers
\usepackage{fancyhdr}
\fancypagestyle{plain}{
    \fancyhf{}%
    \fancyhead[L]{\hspace{-1.2in}\includegraphics[height=1.5cm]{res/sjf_logo}}%
    \fancyfoot[C]{\thepage}%
